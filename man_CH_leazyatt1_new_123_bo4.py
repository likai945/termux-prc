...
def prd_crt_alllines(crt3, crt4, crt5, crt9):
    dct3 = prd_alrm_dct(crt3, 3, 7, 9, 6)
...
def collect_clear_times():
    global clrt3,clrt4,clrt5,clrt9
    clrt3 = clrt4 = clrt5 = clrt9 = 'na'
...
his3, his4, his5, his9 = 'h3.csv','h4.csv','h5.csv','h9.csv'
crt3, crt4, crt5, crt9 = 'c3.csv', 'c4.csv', 'c5.csv', 'c9.csv'
