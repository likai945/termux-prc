...
def main():
    lst = ["jzfz.csv", "jzsl4.csv", "jzsl5.csv", "fzxt4.csv", "fzxt5.csv", "jzsl3.csv", "fzxt3.csv", "vmjzfz.csv"]
    for f in lst:
        shan_wendang(f)
    ...
    chuli_wendang('kx3.csv', 'jzsl3.csv', 3, 'jzsl')
    print("Average and number of kx3 done.")
    chuli_wendang('kx41.csv', 'jzsl4.csv', 3, 'jzsl')
    print("Average and number of kx4 done.")
    chuli_wendang('kx5.csv', 'jzsl5.csv', 3, 'jzsl')
    print("Average and number of kx5 done.")

    chuli_wendang('kx3.csv', 'fzxt3.csv', 0, 'fzxt')
    print("Max and sysavg of kx3 done.")
    chuli_wendang('kx41.csv', 'fzxt4.csv', 0, 'fzxt')
    print("Max and sysavg of kx4 done.")
    chuli_wendang('kx5.csv', 'fzxt5.csv', 0, 'fzxt')
    print("Max and sysavg of kx5 done.")

    chuli_wendang('kx3.csv', 'vmjzfz3.csv', 3, 'vmjzfz')
    print("AvgVM and MaxVM of kx3 done.")
    chuli_wendang('kx41.csv', 'vmjzfz4.csv', 3, 'vmjzfz')
    print("AvgVM and MaxVM of kx4 done.")
    chuli_wendang('kx5.csv', 'vmjzfz5.csv', 3, 'vmjzfz')
    print("AvgVM and MaxVM of kx5 done.")
